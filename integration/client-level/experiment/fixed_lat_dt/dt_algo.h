#ifndef FIXED_LAT_DT_ALGO_H
#define FIXED_LAT_DT_ALGO_H
...
/*
 * Initialize fixed-latency DT state for a replay of total_io_num I/Os.
 * Allocates and initializes historical arrays and calibrates FlashNet
 * inference-time budget used to delay DT inference.
 */
void set_surrogate_dt(int total_io_num);

/*
 * Fixed-latency DT inference.
 *
 * Input:
...
/*
 * Append latest completed IO metrics into historical pools.
 */
...
/*
 * Free arrays allocated by set_surrogate_dt().
 */
